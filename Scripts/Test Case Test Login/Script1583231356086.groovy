...
WebUI.click(findTestObject('Object Repository/Page_Login Admin/label_Email'))

WebUI.click(findTestObject('Object Repository/Page_Login Admin/label_Password'))
...
WebUI.verifyMatch(halamantujuan, 'http://localhost/tokobuah/index.php/admin/login', false)
